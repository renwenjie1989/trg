...
gfx('.navbar .dropdown').click(function() {
...
if (gfx('#google-map-footer').length>0) {
	var e=new google.maps.LatLng(43.643267, -79.401256),
		o={zoom:17,center:new google.maps.LatLng(43.643267, -79.401256),
		...
		var g='<div class="map-marker"><h4 class="color-dark xbold">TRG</h4><p>33 Stewart St.</p><p>Toronto, Ontario, M5V2V8</p><p>Canada</p></div>',a=new google.maps.InfoWindow({content:g})
		...
		i=new google.maps.LatLng(43.643267, -79.401256),
		...
		var z='<div class="map-marker"><h4 class="color-dark xbold">TRG</h4><p>33 Stewart St.</p><p>Toronto, Ontario, M5V2V8</p><p>Canada</p></div>',a=new google.maps.InfoWindow({content:z})
		,t=new google.maps.MarkerImage("img/theme/google-marker.png",new google.maps.Size(157,70),
		new google.maps.Point(0,0),new google.maps.Point(75,50)),
		l=new google.maps.LatLng(43.643267, -79.401256),
...
-------------------------------------------------- */
      ...
      gfx(function() {
        var endDate = "July 31, 2016 09:03:25";
